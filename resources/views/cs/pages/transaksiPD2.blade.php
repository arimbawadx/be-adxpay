...
@section('title') adx-pay | Transaksi Paket Data Internet @endsection

@section('content-header') Transaksi Paket Data Internet @endsection
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" id="form-confirm" method="post" action="/cs/transaksi/PD/3">
          {{csrf_field()}}
          ...
          <div class="form-group">
            ...
            <select id="produk" name="produk" required class="form-control">
              ...
              @if($pp->status=="ACTIVE")
              <option value="{{$pp->product_id}}">{{$pp->operator_name}} {{$pp->product_name}} | Harga Rp. {{number_format($pp->product_price+5000)}}</option>
              @endif
              @endforeach
            </select>
          </div>
      ...
      <div class="col-md-6 col-12">
        ...
        <div class="card">
          <div class="card-body p-2">
            ...
            <div class=""><a href="/cs/transaksi/PD/{{$mts->trxid_api}}" class="btn btn-primary btn-block">Lihat Bukti</a></div>
