...
@section('title') adx-pay | Transaksi Wifi ID @endsection

@section('content-header') Transaksi Wifi ID @endsection
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" method="post" action="/cs/transaksi/wifi-id/2">
          {{csrf_field()}}
          <div class="form-group">
            <input required="" autocomplete="off" type="text" class="form-control" id="no_pelanggan" name="no_pelanggan" pattern="\d*" placeholder="No Handphone. Contoh : 085847801933">
          </div>
          <div class="form-group">
