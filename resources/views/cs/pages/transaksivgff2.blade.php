...
@section('title') adx-pay | Transaksi Free Fire @endsection

@section('content-header') Transaksi Free Fire @endsection
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" id="form-confirm" method="post" action="/cs/transaksi/vgff/3">
          {{csrf_field()}}
            <div class="form-group">
                <label for="no_pelanggan">ID</label>
                <input id="no_pelanggan" required="" autocomplete="off" type="text" class="form-control" name="no_pelanggan" placeholder="Masukan ID FF">
            </div>
          <div class="form-group">
