  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" method="post" action="/cs/transaksi/TL/2">
          {{csrf_field()}}
          <div class="form-group">
            <input required="" autocomplete="off" type="text" class="form-control" id="no_pelanggan" name="no_pelanggan" pattern="\d*" placeholder="No Pelanggan. Contoh : 32019373631">
          </div>
          <div class="form-group">
      ...
      <div class="col-md-6 col-12">
        ...
        <div class="card">
          <div class="card-body p-2">
            ...
            <div class=""><a href="/cs/transaksi/TL/{{$mts->trxid_api}}" class="btn btn-primary btn-block">Lihat Bukti</a></div>
