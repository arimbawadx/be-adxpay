          ...
          <div class="card-body">
            ...
            <div class="container mt-3">
              ...
              <div class="row">
                ...
                <div class="col-6 text-right"><p>Rp. {{number_format($GetPrabayarHistory['price']+5000)}}</p></div>
              </div>
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-6 text-right"><h4 class="text-primary">Rp. {{number_format($GetPrabayarHistory['price']+5000)}}</h4></div>
              </div>
            </div>
          </div>
        </div>
