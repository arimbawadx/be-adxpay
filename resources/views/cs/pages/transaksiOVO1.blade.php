  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" method="post" action="/cs/transaksi/OVO/2">
          {{csrf_field()}}
          <div class="form-group">
            <input required="" autocomplete="off" type="text" class="form-control" id="no_pelanggan" name="no_pelanggan" pattern="\d*" placeholder="No OVO. Contoh : 085847801933">
          </div>
          <div class="form-group">
