  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" id="form-confirm" method="post" action="/cs/transaksi/Bank/3">
          {{csrf_field()}}
          <input name="no_rek" value="{{$no_rek}}" type="hidden">
          <div class="form-group">
            ...
            <select id="produk" name="produk" required class="form-control">
              ...
              <option value="{{$pp->product_id}}">{{$pp->product_name}} | Harga Rp. {{number_format($pp->product_price+4500)}}</option>
              @endif
              @endif
              @endforeach
            </select>
