...
@section('title') adx-pay | Transaksi Diamond FF @endsection

@section('content-header') Transaksi Diamond FF @endsection
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" id="form-confirm" method="post" action="/cus/transaksi/vgff/3">
          {{csrf_field()}}
            <div class="form-group">
                ...
                <input id="no_hp" required="" autocomplete="off" type="text" class="form-control" name="no_hp" placeholder="Masukan ID FF">
            </div>
          <div class="form-group">
