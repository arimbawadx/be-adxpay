...
@section('title') adx-pay | Transaksi OVO @endsection

@section('content-header') Transaksi OVO @endsection
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" method="post" action="/cus/transaksi/OVO/2">
          {{csrf_field()}}
          <div class="input-group">
            <input id="no_tujuan" required="" autocomplete="off" type="text" class="form-control" name="no_hp" minlength="11" maxlength="14" pattern="\d*" placeholder="No OVO. Contoh : 085847801933">
