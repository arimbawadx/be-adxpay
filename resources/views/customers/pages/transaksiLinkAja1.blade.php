...
@section('title') adx-pay | Transaksi LinkAja @endsection

@section('content-header') Transaksi LinkAja @endsection
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" method="post" action="/cus/transaksi/LinkAja/2">
          {{csrf_field()}}
          <div class="input-group">
            <input id="no_tujuan" required="" autocomplete="off" type="text" class="form-control" name="no_hp" minlength="11" maxlength="14" pattern="\d*" placeholder="No LinkAja. Contoh : 085847801933">
