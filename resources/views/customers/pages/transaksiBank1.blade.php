  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" method="post" action="/cus/transaksi/Bank/2">
          {{csrf_field()}}
          ...
          <div class="form-group">
            <input required="" autocomplete="off" type="text" class="form-control" id="no_rek" name="no_hp" pattern="\d*" placeholder="No Rekening. Contoh : 011401021881505">
          </div>
          <div class="form-group">
