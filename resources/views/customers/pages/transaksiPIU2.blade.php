  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-12">
        <form class="card card-body" id="form-confirm" method="post" action="/cus/transaksi/PIU/3">
          {{csrf_field()}}
          ...
          <div class="form-group">
            ...
            <select id="produk" name="produk" required class="form-control">
              ...
              @if($pp->status=="ACTIVE")
              <option value="{{$pp->product_id}}">{{$pp->operator_name}} {{$pp->product_name}} | Harga Rp. {{$pp->product_name+2.000}}.000</option>
              @endif
              @endforeach
            </select>
          </div>
